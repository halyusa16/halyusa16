...
I am a dedicated **Data and Analytics Engineer** with experience and projects in designing and implementing **ETL/ELT pipelines**, utilizing cloud data warehouse, and performing analysis. 

I was a Data Engineer Intern at Paper.id, where I applied data analytics engineering practices.

Let's connect with me on **[LinkedIn](https://www.linkedin.com/in/halyusaard)**
...
| **Space People API** | Python (requests) | Demonstrates API integration fundamentals in Python | [Repo](https://github.com/halyusa16/fetch-space-people-api) |
...
| **Data Warehousing** | Google BigQuery, PostgreSQL, MySQL |
| **Transformation & Orchestration**| dbt (Data Build Tool), Airflow |
